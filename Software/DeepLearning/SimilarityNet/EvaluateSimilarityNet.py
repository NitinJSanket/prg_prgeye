...
def TestOperation(PatchPH, I1PH, I2PH, PerturbParamsPH, PerturbHPH, ImageSize, PatchSize, ModelPath, ReadPath,\
    ...
    VN = Net.ShuffleNetv2(InputPH = PatchPH, Training = True, Opt = opt, InitNeurons = InitNeurons)
    # Predict output with forward pass
...
def main():
    ...
    Parser.add_argument('--NetworkName', default='Network.ShuffleNetv23Small', help='Name of network file, Default: Network.VanillaNet')
